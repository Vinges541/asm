...
vm_handler vm_handlers[VM_COUNT_HAND] = {vm_nop, vm_in, vm_out, vm_mov, vm_add, vm_sub, vm_xor, vm_and, vm_or};
...
vm_instruction *ins;
static char *mnem[] = {"nop", "in", "out", "mov", "add", "sub", "xor", "and", "or"};
