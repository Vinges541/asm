...
document envp
usage: envp addr_envp
Show environments by envp pointer.
end
...
document main_argv
usage: main_argv addr_argv
Show arguments of main function by argv pointer.
end
...
document u
usage: u addr [count]
Disas by addr count instruction
end
