/****************************************************************************
    ...
    Демонстрирует пример перемещения шашек на шахматной доске.
...
HWND hwnd;  // описатель окна
    ...
    hwnd = CreateWindowEx(
                          ...
                          "Simple Checkers",          // заголовок окна
...
unsigned int i,j;
    ...
    switch (iMsg){
        case WM_CREATE:
            CreateCheckerWindow(hIns,hwnd,RGB(100,100,100),200,200);
            CreateCheckerWindow(hIns,hwnd,RGB(200,200,200),300,300);
            return 0 ;
