...
;
; Маткин Илья Александрович     14.12.2013
;
...
RegisterClassChessWindow proc hIns:HINSTANCE
    ...
    mov WndClass.lpfnWndProc, WndProcChess      ; адрес оконной процедуры класса
    ...
    mov WndClass.lpszClassName, $CTA0(ChessWindowName)	; имя класса
...
SIZE_FIG        equ     40
    ...
    ; получаем информацию о картинке в структуру
...
CreateChessWindow proc hIns:HINSTANCE, parent:HWND, color:COLORREF, x:dword, y:dword, ftype: FIGTYPE
    ...
    local hwnd:HWND     ; описатель окна
    local rgn:HRGN      ; описатель региона
